...
const Login = () => {
  ...
  if (submitting) {
    return (
      <div className="bg-white flex justify-center items-center min-h-[100dvh] w-[100dvw] transition-all duration-1000 absolute top-0 left-0 z-50">
  ...
  return (
    <div className="w-full min-h-[100dvh] flex flex-col-reverse lg:flex-row bg-white text-black justify-center items-center absolute top-0 left-0 z-50">
          ...
          <div className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                required
                className="placeholder:text-[#817e7e] rounded-[3px] border-black"
                {...register("email")}
              />
            </div>
            <div className="grid gap-2">
              ...
              <Input
                ...
                type="password"
                required
                className="rounded-[3px] border-black"
                {...register("password")}
              />
            </div>
