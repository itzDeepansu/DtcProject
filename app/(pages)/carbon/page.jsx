...
export default function Component() {
  ...
  return (
    <div className="container p-4 text-black bg-white rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {routeNumbers.map((routeNumber, index) => (
          <Card key={routeNumber} className="border-[#4c4c4c] bg-gradient-to-br from-[#abedf336] to-white shadow-md hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="space-y-1 pb-2">
              <CardTitle className="text-lg font-semibold text-center text-green-700">Route {routeNumber}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="bg-transparent rounded-lg p-2 shadow-inner">
